...
- Database Explorer (Task 11): `test_explorer_policy.py` (every ORM table classified, unexposed/unknown/injected
  ...
  synthetic dataset served by `python -m tests.e2e_server` (table pick, sort, filter, search, value viewer, FK hop
